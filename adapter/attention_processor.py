...
from timm.models.layers import create_act_layer, get_act_layer,make_divisible, ConvMlp, LayerNorm2d
...
class ChannelAttention(nn.Module):
    def __init__(self, channel, reduction=16, cross_attention_dim=None, scale=1.0):
        super().__init__()
        self.cross_attention_dim = cross_attention_dim
        self.scale = scale
...
class SpatialAttention(nn.Module):
    def __init__(self, in_channels, kernel_size=7, cross_attention_dim=None, scale=1.0):
        super().__init__()
        self.cross_attention_dim = cross_attention_dim
        self.scale = scale
...
class CBAMBlock(nn.Module):
    ...
    def __init__(self, hidden_states,in_channels, reduction=16, kernel_size=7, cross_attention_dim=None, scale=1.0):
        super().__init__()
        self.hidden_state = hidden_states
        self.cross_attention_dim = cross_attention_dim
        self.scale = scale
        self.ca = ChannelAttention(channel=in_channels, reduction=reduction)
        self.sa = SpatialAttention(in_channels, kernel_size=kernel_size)
